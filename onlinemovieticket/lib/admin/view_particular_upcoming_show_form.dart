...
import 'package:onlinemovieticket/admin/view_particular_upcoming_show.dart';
...
class view_particular_upcoming_show_form extends StatefulWidget {
  const view_particular_upcoming_show_form({Key? key}) : super(key: key);

  @override
  State<view_particular_upcoming_show_form> createState() =>
      _view_particular_upcoming_show_formState();
}

class _view_particular_upcoming_show_formState
    extends State<view_particular_upcoming_show_form> {
  //controller for all textfield
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      "View Particular Upcoming Shows",
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    //control goes to view_particular_upcoming_show
                                    view_particular_upcoming_show(
                                        moviename.text,
                                        date1.text,
                                        date2.text)));
                      },
