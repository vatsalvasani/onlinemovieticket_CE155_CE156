...
import 'package:onlinemovieticket/admin/view_particular_passed_out_shows.dart';
...
class view_particular_passed_out_show_form extends StatefulWidget {
  const view_particular_passed_out_show_form({Key? key}) : super(key: key);

  @override
  State<view_particular_passed_out_show_form> createState() => _view_particular_passed_out_show_formState();
}

class _view_particular_passed_out_show_formState extends State<view_particular_passed_out_show_form> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Particular Passed Out Shows",style: TextStyle(color: Colors.white),),backgroundColor: Colors.pink,),
      drawer: Drawer(
        width: 400,
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      "View Particular Passed Out Shows",
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    ElevatedButton(
                      onPressed: () {
                        //controller goes to view_particular_passed_out_show with given parameters
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>view_particular_passed_out_show(
                            moviename.text,
                            date1.text,
                            date2.text
                        )));
