...
class report_passedout extends StatefulWidget {
  ...
  report_passedout(
      ...
      this.date);
  @override
  State<report_passedout> createState() => _report_passedoutState();
}

class _report_passedoutState extends State<report_passedout> {
        ...
        build: (context) {
          return pw.Center(
            ...
            children: [
              ...
              pw.Center(
                child: pw.Text(
                  'Final Report Of Passed Out Show',
                  style: pw.TextStyle(
                    fontSize: 30,
                  ),
                ),
